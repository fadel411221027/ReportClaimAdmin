<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-2 sm:pt-0 ">
        <div class="w-full sm:max-w-md px-6 py-4 shadow-md overflow-hidden sm:rounded-lg">
            <div>
                <h2 id="greeting" class="-mt-6 text-center text-3xl font-extrabold text-emerald-400">
                    Report Claim Admin
                </h2>
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="username" name="username" type="text" requiemerald
                            class="appearance-none relative block w-full px-3 py-2 border @error('username') border-emerald-300 @else @enderror placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm mt-1"
                            placeholder="Masukan akun Anda" value="{{ old('username') }}">
                    </div>
        
                    <div class="mt-4">
                        <label for="password" class="block text-sm font-medium text-gray-700">Kata sandi</label>
                        <input id="password" name="password" type="password" requiemerald
                            class="appearance-none relative block w-full px-3 py-2 border @error('password') border-emerald-300 @else @enderror placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm mt-1"
